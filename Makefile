...
export DEVELOPMENT_PROVISIONING_PROFILE_APP=PROFILE
export DISTRIBUTION_PROVISIONING_PROFILE_APP=PROFILE
export DEVELOPMENT_PROVISIONING_PROFILE_EXTENSION_SHARE=PROFILE
export DISTRIBUTION_PROVISIONING_PROFILE_EXTENSION_SHARE=PROFILE
export DEVELOPMENT_PROVISIONING_PROFILE_EXTENSION_WIDGET=PROFILE
export DISTRIBUTION_PROVISIONING_PROFILE_EXTENSION_WIDGET=PROFILE
export DEVELOPMENT_PROVISIONING_PROFILE_EXTENSION_NOTIFICATIONSERVICE=PROFILE
export DISTRIBUTION_PROVISIONING_PROFILE_EXTENSION_NOTIFICATIONSERVICE=PROFILE
export DEVELOPMENT_PROVISIONING_PROFILE_EXTENSION_NOTIFICATIONCONTENT=PROFILE
export DISTRIBUTION_PROVISIONING_PROFILE_EXTENSION_NOTIFICATIONCONTENT=PROFILE
export DEVELOPMENT_PROVISIONING_PROFILE_EXTENSION_INTENTS=PROFILE
export DISTRIBUTION_PROVISIONING_PROFILE_EXTENSION_INTENTS=PROFILE
export DEVELOPMENT_PROVISIONING_PROFILE_WATCH_APP=PROFILE
export DISTRIBUTION_PROVISIONING_PROFILE_WATCH_APP=PROFILE
export DEVELOPMENT_PROVISIONING_PROFILE_WATCH_EXTENSION=PROFILE
export DISTRIBUTION_PROVISIONING_PROFILE_WATCH_EXTENSION=PROFILE
...
BUCK_OPTIONS=\
<<<<<<< HEAD
	--config custom.appVersion="${AppVersion}" \
=======
	--config custom.appVersion="${APP_VERSION}" \
>>>>>>> b3ab501a75cd12ff079f32c299dea4a38ac61bba
